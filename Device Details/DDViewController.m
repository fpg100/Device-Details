...
- (void) getDeviceDetails{
    ...
    if ([platform isEqualToString:@"iPad2,2"])      deviceTypeLabel.text = @"iPad 2 (Cellular)";
    if ([platform isEqualToString:@"iPad2,3"])      deviceTypeLabel.text = @"iPad 2 (Cellular)";
    ...
    if ([platform isEqualToString:@"iPad2,6"])      deviceTypeLabel.text = @"iPad Mini (Cellular)";
    if ([platform isEqualToString:@"iPad2,7"])      deviceTypeLabel.text = @"iPad Mini (Cellular)";
    if ([platform isEqualToString:@"iPad3,1"])      deviceTypeLabel.text = @"iPad 3 (WiFi)";
    if ([platform isEqualToString:@"iPad3,2"])      deviceTypeLabel.text = @"iPad 3 (Cellular)";
    if ([platform isEqualToString:@"iPad3,3"])      deviceTypeLabel.text = @"iPad 3 (Cellular)";
    if ([platform isEqualToString:@"iPad3,4"])      deviceTypeLabel.text = @"iPad 4 (WiFi)";
    if ([platform isEqualToString:@"iPad3,5"])      deviceTypeLabel.text = @"iPad 4 (Cellular)";
    if ([platform isEqualToString:@"iPad3,6"])      deviceTypeLabel.text = @"iPad 4 (Cellular)";
    if ([platform isEqualToString:@"iPad4,1"])      deviceTypeLabel.text = @"iPad Air (WiFi)";
    if ([platform isEqualToString:@"iPad4,2"])      deviceTypeLabel.text = @"iPad Air (Cellular)";
